...
<div class="content"> 
	...
	<div class="grid-x grid-padding-x">
	  ...
	  <div class="medium-12 grid-x lesson-copy">
	    ...
	    “<a class="button dropdown-question" data-question="q8_1" data-drawer-id="drawer-one" onclick="showDrawer(this);">Select an option</a>"  
	    </p>
	  </div>
	  <input type="hidden" class="q8_1 dd-response" name="q8_1"></input>
	</div>
...
<div id="drawer-one" class="drop-down-drawer q8_1 text-center" style="height: 128px;">
	<a class="button secondary answer-option q8_1" data-value="1">her competitor took a deep breath and began to spell.</a>
	<a class="button secondary answer-option q8_2" data-value="2">her competitor misspelled the word.</a>
	<a class="button secondary answer-option q8_3" data-value="3">her competitor looked around the room.</a>	
</div>

</div>
 <script>
      	$(document).foundation();
      	var answerKey = {q8_1:"1"};
      	var hintArray = {
      	      	"hint_q8_1":{
      	...
      	var rationaleArray = {
      	      	"rationale_q8_1":"Suspense is excitement or fear about the unknown. As Joan’s competitor begins to spell the word, \
    	...
    	storage["quiz_total"]=0;
      	$(document).ready(function() {
			ClozeDropdown.initialize("practice_8",1,1);
