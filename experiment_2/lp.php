...
<html>
	<head>
	  ...
	  <style>
	  	.subtitle {color: #58595B;	font-family: Roboto;	font-size: 18px;	line-height: 24px;}
	    .title {background-color:#FBFBFB; color:#4A90E2; height:82px;padding-top: 22px;padding-left:114px;margin-bottom:0;}
	    .copy-here{color: #454346;	font-family: Roboto;	font-size: 16px;	line-height: 24px;    width: 570px; margin: 0 auto;}
	  </style>
	</head>
