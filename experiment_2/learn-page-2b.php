		...
		<div class="overview-content">
			...
			<div class="grid-x grid-padding-x">
				...
				<div class="medium-12  lesson-desc" style="font-family:'Roboto', serif;font-size:20px; font-color#4a4a4a;margin-top:31px  ">
					...
					<div style="width:272px;float:left;	border: 2px solid #00B5BA; padding:23px;" class="part-5">Words and phrases can be used to organize ideas based on their importance, or how much special attention the information deserves. For example, a writer may organize their ideas with words and phrases like, “Most importantly”, “Especially” or “Above all”.</div>
				</div>
			</div>
			</div>
		</div>
